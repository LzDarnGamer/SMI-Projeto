                            ...
                            <div class="form-group">
                                <div class="input-group mb-3">
                                    <div class="autocomplete" style="width:300px;">
                                        <input id="myInput" type="text" class="form-control" name="FilterUsername" placeholder="Search By User" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Search By User'">
                                    </div>
                                </div>
                            </div>
